...
def RabiOsci(t, Omega, Omega_0):
    '''
    Excitation probability after addressing the ion with a detuned radiation with time t under radi freq omega
...
def EffRabiFreq(n, m, lamb, w, om_0):
    ...
    factor3 = genlaguerre(sp.amin([n, m]), n_diff)(eta**2)
...
def PlotRedSb(n0):
    '''
    Plot the relative strengths of the carrier, first and second sidebands at and below quantum number n0
    '''
    fig, ax = plt.subplots()
    ...
    return ax
#PlotRedSb(60)
n0, N = 50, 1000 # starts at n = 50 and does 100 times
